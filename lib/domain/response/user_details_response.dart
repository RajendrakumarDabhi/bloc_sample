class UserDetailsResponse {
  ...
  const UserDetailsResponse({this.data, this.support});
  UserDetailsResponse copyWith({Data? data, Support? support}) {
    return UserDetailsResponse(
        data: data ?? this.data, support: support ?? this.support);
  }
  ...
  static UserDetailsResponse fromJson(Map<String, Object?> json) {
    return UserDetailsResponse(
        data: json['data'] == null
            ? null
...
support:${support.toString()}
  ...
  bool operator ==(Object other) {
    return other is UserDetailsResponse &&
